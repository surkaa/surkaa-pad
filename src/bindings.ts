...
export type EditorShortcutSettings = { bold: string; underline: string; strike: string; heading1: string; heading2: string; heading3: string; taskList: string; summary: string; insertPhoto: string; insertAudio: string; audioRecording: string; insertVideo: string; insertFile: string }
