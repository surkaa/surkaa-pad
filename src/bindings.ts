...
export type AiSessionMessagePayload = { role: "user"; content: string } | { role: "assistant"; state: AiAssistantRecordState; content: string; error: string | null; model: string; usage: AiUsage | null; processSteps: AiProcessStepRecord[]; trace: AiConversationSourceMessage[] }
